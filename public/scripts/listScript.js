...
async function filltables(data, table){
    ...
    data.forEach(element => {
        ...
        tablerow.innerHTML =
            ...
            <td class="table-borders"><a href="details.html?id=${element.id}" tabindex=${tabindex+5}>View Full Form</a></td>
            <td class="table-borders"><a href="edit.html?id=${element.id}" tabindex=${tabindex+10}>Edit Form</a></td>
            `
        tabindex+=20;
        row++;
    });
