...
export const seedTables = [
    ...
    `INSERT INTO Quality (NCRFormID, NCRNumber, SalesOrder, SRInspection, WorkInProgress, ItemDescription, QuantityReceived, QuantityDefective, IsNonConforming, Details, QualityStatus, LastModified, ProductID) VALUES 
                (1, '2024-001', 376, 1, 0, 'Industrial Hammer', 50, 5, 1, 'Loose hammer handles on 5 units.', 'Closed', '2024-10-02', 48), 
                (2, '2024-002', 392, 0, 1, 'Impact Drill', 30, 3, 1, '3 drills with faulty motors.', 'Closed', '2024-10-04', 69), 
                (3, '2024-003', 222, 1, 0, 'Safety Mask', 100, 25, 1, 'Mask straps are broken', 'Closed', '2024-10-06', 46),
                (4, '2024-004', 408, 0, 1, 'Safety Harness', 10, 3, 1, 'Clasps are broken', 'Open', '2024-10-08', 82),
                (5, '2024-005', 121, 1, 0, 'Tool Box', 5, 1, 1, 'Hinge is broken on 1 unit', 'Open', '2024-10-10', 49),
                (6, '2024-006', 421, 0, 1, 'Sealing Tape', 250, 1, 1, 'Tape isnt sticky', 'Closed', '2024-10-12', 52),
                (7, '2024-007', 123, 1, 0, 'Ball Bearing', 100, 20, 1, 'Bearings arent correcly assembled', 'Open', '2024-10-14', 1),
                (8, '2024-008', 478, 0, 1, 'Industrial Hose', 20, 1, 1, 'Hose has a hole in it', 'Open', '2024-10-16', 11),
                (9, '2024-009', 499, 1, 0, 'Safety Helmet', 50, 5, 1, 'Helmets arent the right colour', 'Open', '2024-10-18', 18),
                (10, '2024-010', 910, 0, 1, 'Hydraulic Oil', 100, 50, 1, 'Recieved AW46 oil instead of the AW32 oil', 'Open', '2024-10-20', 26)`,
